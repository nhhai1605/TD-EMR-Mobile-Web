...
import { Event, eventColors } from '@core/models/appointments/patientAppointment';
...
const CalendarApp = ({ events, onEventClick, ...calendarProps }: CalendarProps) => {
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <Box>
          <IconButton aria-label='previous' component='span' onClick={handlePrev}>
            <ArrowLeftIcon />
          </IconButton>
          <Button onClick={handleToday}>{t('common.today')}</Button>
          <IconButton aria-label='next' component='span' edge='end' onClick={handleNext}>
            <ArrowRightIcon />
          </IconButton>
        </Box>
      </Box>
